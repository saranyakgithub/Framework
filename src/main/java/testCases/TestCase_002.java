...
public class TestCase_002 {
	...
	public void testSearchProduct()
	{
			...
			try {
			Boolean verifyTitle = driver.getTitle().equalsIgnoreCase("Amazon.co : Smart Tv");
			assertTrue(verifyTitle);
			
			if(verifyTitle) {
				DBConnect.insertRecord("TC002",Utils.currentTimestamp(),"Pass");
			}
		...
		{
			DBConnect.insertRecord("TC002",Utils.currentTimestamp(),"Fail");
		}
		catch(Exception e)
		{
